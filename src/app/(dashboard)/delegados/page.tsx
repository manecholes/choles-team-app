...
export default function DelegadosPage() {
  ...
  const [resetTarget, setResetTarget] = useState<Delegate | null>(null);
      ...
      render: (d) =>
        d.user ? (
          <div className="flex items-center gap-2">
            ...
            <button className="btn-ghost" title="Restablecer contrasena" onClick={() => setResetTarget(d)}>
  ...
  return (
    <div className="space-y-4">
      ...
      <ResetPasswordModal
        ...
        endpoint={resetTarget ? `/api/delegates/${resetTarget.id}/user` : ""}
        onDone={loadData}
      />
    </div>
  );
