...
import { createDelegateUserAccess, resetDelegatePassword } from "@/server/services/staff.service";
...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const updated = await resetDelegatePassword(clubId, Number(params.id), data.password);
